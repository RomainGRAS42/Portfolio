...
const About: React.FC<AboutProps> = ({ onContactClick }) => {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Mouse Trail Effect - Desktop Only (Fixed background) */}
      <div className="hidden lg:block fixed inset-0 z-0 opacity-80 pointer-events-none">
        <MouseTrailEffect />
      </div>

      <div className="pt-32 px-6 sm:px-10 md:px-16 max-w-7xl mx-auto pb-20 relative z-10">
        {/* Hero Section */}
